<?php 
	$a = $_POST['id'];
	require("../conn.php");
	$sql="select * from suppliers where id_suppliers='".$a."'";
	$ambil_data= mysql_query($sql);	
	while($data=mysql_fetch_array($ambil_data))
	{
?>
<form class="form-horizontal" method="post" action="../config/supplier/suppliers_exe_update.php">
  <div class="form-group">
	...
	<div class="form-group">
    	...
    	<div class="col-sm-5">
      	<input value="<?php  echo $data["nama"]?>" type="text" class="form-control" name="nama" autocomplete="off" required>
    	</div>
  </div>
   <div class="form-group">
