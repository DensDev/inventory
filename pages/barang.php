        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalBarang">Tambah Barang</button>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            &nbsp;
            <table id="dataTables-example" class="table table-striped table-bordered table-hover">
                ...
                $sql="select produk.id_produk,produk.kode,produk.nama_p,produk.qty,produk.id_customers,customers.id_customers,customers.customers_name from produk,customers where produk.id_customers = customers.id_customers";
                ...
                <tr class='odd gradeX'>
                    ...
                    <td><i class="fa fa-pencil-square-o" aria-hidden="true"><a href="#" class="edit-record" value= "<?php echo $data['id_produk'] ?>">Edit</a> </i>  
                        <i class="fa fa-trash-o" aria-hidden="true"><a href="hapus_barang.php?id_produk=<?php echo $data['id_produk'] ?>" onClick="return confirm ('Yakin akan menghapus?')">Hapus</a></i>
                    </td>
                </tr>
                <?php } ?>
                </tbody>
...
<div id="modalBarang" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <form class="form-horizontal" method="post" action="../config/barang/barang_add.php">
  <div class="form-group">
    <label class="control-label col-sm-2">Kode:</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" name="kode" placeholder="Kode Barang"  onkeypress='return isNumberKeyTrue(event)' required>
    </div>
  </div>
  <div class="form-group">
    ...
    <script>
        $(function(){
            $(document).on('click','.edit-record',function(e){
                ...
                $.post('../config/barang/barang_modal_update.php',
                    {id:$(this).attr('value')},
                    function(html){
